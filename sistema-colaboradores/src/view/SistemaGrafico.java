...
public class SistemaGrafico extends JFrame {
    ...
    private void configurarJanela() {
        setTitle("Sistema de Colaboradores e Folha de Pagamento");
        setSize(1050, 680);
    ...
    private JPanel criarSidebar() {
        ...
        JLabel lblLogo = new JLabel("Sistema de Colaboradores");
        lblLogo.setFont(new Font("Segoe UI", Font.BOLD, 16));
        lblLogo.setForeground(Color.WHITE);
        lblLogo.setAlignmentX(Component.LEFT_ALIGNMENT);

        JLabel lblSub = new JLabel("e Folha de Pagamento v1.0");
    ...
    private JPanel criarPainelFolha() {
        ...
        JLabel lblRecEmp = new JLabel("SISTEMA DE COLABORADORES E FOLHA DE PAGAMENTO S.A. | CNPJ 00.000.000/0001-99");
        lblRecEmp.setFont(new Font("Segoe UI", Font.BOLD, 9));
        ...
        // Rodapé do recibo
        JLabel lblAssinatura = new JLabel("Processado Digitalmente pelo Sistema de Folha");
